...
/*Este método recibe la información extrínseca. No se mantiene alguna referencia a la posición actual o nueva posición*/
        ...
        public void moverAuto(int actualX, int actualY, int newX ,int newY){
            System.out.println("La informacion invariante (intrinseca) para este auto es: Nombre: " + this.getNombre() + "; " + "Velocidad maxima: " + this.getVelMax() + "; "+ "Potencia:  " + this.getPotencia());
            System.out.println("La nueva posicion de "+this.getNombre() +" es X: "+newX + " - Y: "+newY);
